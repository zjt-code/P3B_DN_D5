...
/* 自定义服务的UUID */
#define CS_SVC_UUID                                                    {0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0x1F,0x18,0x00,0x00}
#define CS_CHARACTERISTIC_CGM_MEASUREMENT_UUID                         {0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0xA7,0x2A,0x00,0x00}
#define CS_CHARACTERISTIC_CGM_SPECIFIC_OPS_UUID                        {0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0xAC,0x2A,0x00,0x00}
#define CS_CHARACTERISTIC_CGM_FEATURE_UUID                             {0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0xA8,0x2A,0x00,0x00}
#define CS_CHARACTERISTIC_CGM_STATE_UUID                               {0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0xA9,0x2A,0x00,0x00}
#define CS_CHARACTERISTIC_CGM_SESSION_START_TIME_UUID                  {0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0xAA,0x2A,0x00,0x00}
#define CS_CHARACTERISTIC_CGM_SESSION_RUN_TIME_UUID                    {0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0xAB,0x2A,0x00,0x00}
#define CS_CHARACTERISTIC_RECORD_ACCESS_CONTROL_UUID                   {0xfb,0x34,0x9b,0x5f,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0x52,0x2A,0x00,0x00}

/* char 数据buffer长度 */
#define CS_CGM_MEASUREMENT_MAX_LENGTH               16
#define CS_CGM_SPECIFIC_OPS_MAX_LENGTH              20
#define CS_USER_DESCRIPTION_MAX_LENGTH              20
#define CS_RECORD_ACCESS_CONTROL_MAX_LENGTH         20
#define CGMS_CCCD_VALUE_MAX                         2

/* char 名称 */
#define CS_CGM_MEASUREMENT_CHARACTERISTIC_NAME                         "CGM_MEASUREMENT"
#define CS_CGM_SPECIFIC_OPS_CHARACTERISTIC_NAME                        "CGM_SPECIFIC_OPS"
#define CS_CGM_FEATUREG_CHARACTERISTIC_NAME                            "CGM_FEATUREG"
#define CS_CGM_STATE_CHARACTERISTIC_NAME                               "CGM_STATUS"
#define CS_CGM_SESSION_START_TIME_CHARACTERISTIC_NAME                  "CGM_SESSION_START_TIME"
#define CS_CGM_SESSION_RUN_TIME_CHARACTERISTIC_NAME                    "CGM_SESSION_RUN_TIME"
#define CS_RECORD_ACCESS_CONTROL_CHARACTERISTIC_NAME                   "RECORD_ACCESS_CONTROL"
...
uint8_t att_ccc_char_callback(uint8_t conidx, uint16_t attidx, uint16_t handle, uint8_t* to, const uint8_t* from, uint16_t length, uint16_t operation);
uint16_t is_measurement_notify(void);
uint16_t is_socp_notify(void);
uint16_t is_racp_notify(void);
