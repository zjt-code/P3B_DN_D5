...
#ifndef SL_SPIDRV_USART_AFESPIINST_CONFIG_H
#define SL_SPIDRV_USART_AFESPIINST_CONFIG_H
...
// <i> Default: 1000000
#define SL_SPIDRV_USART_AFESPIINST_BITRATE           490000

// <o SL_SPIDRV_USART_AFESPIINST_FRAME_LENGTH> SPI frame length <4-16>
// <i> Default: 8
#define SL_SPIDRV_USART_AFESPIINST_FRAME_LENGTH      8

// <o SL_SPIDRV_USART_AFESPIINST_TYPE> SPI mode
// <spidrvMaster=> Master
// <spidrvSlave=> Slave
#define SL_SPIDRV_USART_AFESPIINST_TYPE              spidrvMaster

// <o SL_SPIDRV_USART_AFESPIINST_BIT_ORDER> Bit order on the SPI bus
// <spidrvBitOrderLsbFirst=> LSB transmitted first
// <spidrvBitOrderMsbFirst=> MSB transmitted first
#define SL_SPIDRV_USART_AFESPIINST_BIT_ORDER         spidrvBitOrderMsbFirst

// <o SL_SPIDRV_USART_AFESPIINST_CLOCK_MODE> SPI clock mode
...
#define SL_SPIDRV_USART_AFESPIINST_CLOCK_MODE        spidrvClockMode0
...
#define SL_SPIDRV_USART_AFESPIINST_SLAVE_START_MODE  spidrvSlaveStartImmediate
// </h>
...
#define SL_SPIDRV_USART_AFESPIINST_TX_PORT       gpioPortC
#endif
#ifndef SL_SPIDRV_USART_AFESPIINST_TX_PIN       
#define SL_SPIDRV_USART_AFESPIINST_TX_PIN        5
#endif

// USART0 RX on PC02
#ifndef SL_SPIDRV_USART_AFESPIINST_RX_PORT      
#define SL_SPIDRV_USART_AFESPIINST_RX_PORT       gpioPortC
#endif
#ifndef SL_SPIDRV_USART_AFESPIINST_RX_PIN       
#define SL_SPIDRV_USART_AFESPIINST_RX_PIN        2
#endif
...
#define SL_SPIDRV_USART_AFESPIINST_CLK_PIN       6
#endif
...
#endif // SL_SPIDRV_USART_AFESPIINST_CONFIG_H
