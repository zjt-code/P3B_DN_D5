...
bool sl_bt_in_place_ota_dfu_is_boot_to_dfu(void)
{
  return boot_to_dfu;
}
    ...
    case sl_bt_evt_gatt_server_user_write_request_id:
      ...
      if (evt->data.evt_gatt_server_user_write_request.characteristic
        ...
        if (sl_bt_in_place_ota_dfu_security_status(addr, conn_hdl, bond_hdl)
          ...
          // Boot into DFU mode.
          boot_to_dfu = true;
          sl_bt_connection_set_parameters(evt->data.evt_gatt_server_user_write_request.connection, 24, 24, 0, 72, 0xffff, 0xffff);
        }
